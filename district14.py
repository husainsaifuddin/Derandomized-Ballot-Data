            ...
            for session in sessions:
                ...
                for card in cards:
                    ...
                    for contest in contests:
                        if contest.get("Id") == 4:  # Filter ContestId: 4
                            marks = contest.get("Marks", [])
                            for mark in marks:
                                candidate_id = mark.get("CandidateId")
                                if candidate_id in [121, 120]:  # Petel (121) or Speier (120)
                                    vote_data.append({
                                        "Timestamp": timestamp,
...
candidate_map = {120: "Jackie Speier", 121: "Ran S. Petel"}
...
# Plot the data
colors = ['blue', 'red']  # Blue for speier, Red for petel
